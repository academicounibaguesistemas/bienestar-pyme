...
const Configuracion = {
  ...
  /** Agrega un usuario nuevo o, si se esta editando, guarda los cambios sobre el usuario existente. */
  ...
  /** Las areas creadas aqui son las mismas que se ofrecen en el select de la encuesta (sin listas fijas). */
  guardarArea(event) {
    event.preventDefault();
  ...
  /** El primer periodo creado queda activo automaticamente (ver DataStore.agregarPeriodo). */
